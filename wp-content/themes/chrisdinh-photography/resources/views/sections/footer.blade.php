...
<footer class="content-info mt-36 mb-8 {{ $footerClasses }}">
    ...
    <div class="max-w-7xl mx-auto my-6 md:my-8 border-t border-white px-5"></div>

    <!-- Footer content constrained within the same width and padding -->
    <div class="max-w-7xl mx-auto flex flex-row justify-between items-center text-white space-y-0 px-5">
      <!-- Phone Number (Left) -->
      @if($phoneNumber)
